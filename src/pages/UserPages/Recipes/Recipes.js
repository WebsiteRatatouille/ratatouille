...
function Recipes() {
  ...
  filteredRecipes =
    category === "All"
      ? food_list
      : food_list.filter((recipe) => recipe.category === category);
    ...
    <div className="recipes">
      ...
      <div className="recipes-body-wrapper">
        <div className="title">
          ...
          <p>
            Chúng tôi hiểu những băn khoăn của bạn. Chúng tôi đồng hành cùng
            bạn. Đây là những công thức nấu ăn tuyệt vời, được thử nghiệm và
